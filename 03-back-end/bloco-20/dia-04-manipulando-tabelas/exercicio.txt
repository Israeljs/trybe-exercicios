...
2 : Procurando foi classificado em 6.8, fez 450 milhões e 370 milhões. Altere a tabela BoxOffice .     
INSERT INTO BoxOffice(movie_id, rating, domestic_sales, international_sales)
  VALUES (9, 6.8, 45000000, 370000000);

3 : O diretor do filme "Procurando Nemo" está incorreto, foi dirigido por Andrew Staton. Corrija com UPDATE 
SET SQL_SAFE_UPDATES = 0;
UPDATE Movies
SET director = 'Andrew Staton'
WHERE title = 'Procurando Nemo';

4 : "Ratatouille" está incorreto na tabela Movies , além disso, o filme foi lançado em 2007. Corrija com UPDATE .
UPDATE Movies
