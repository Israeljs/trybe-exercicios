...
function isManager(employeeId) {
  return managers.some((manager) => manager === employeeId);
}
console.log(employees.filter((employee) => employee.id === '533bebf3-6bbe-41d8-9cdf-46f7d13b62ae'))
// function getRelatedEmployees(managerId) {
//   // let result = [];
//   if (isManager(managerId)) {
//     const colaboradores = employees.find(({ id }) => id === managerId).responsibleFor;
//     const result = employees.filter((employee) => employee.id === '533bebf3-6bbe-41d8-9cdf-46f7d13b62ae');
//     return result;
//   }
// }
