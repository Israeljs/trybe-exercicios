...
//  em Marte, gastando um tempo variável de até 5 segundos para que termine o 
//  envio. Crie a função sendMarsTemperature, que imprime a temperatura em Marte.
...
const sendMarsTemperature = () => {
  ...
  setTimeout(() => {
    ...
    `Mars temperature is: ${temperature} degree Celsius`
}
